...
public sealed partial class EmittableResourceSerializerFactory : SerializerFactory<ProcessedEmittableResourceDTO> {
    protected override Serializer<ProcessedEmittableResourceDTO> CreateSerializer(ProcessedEmittableResourceDTO serializingObject, SerializationContext context) {
    ...
    private sealed partial class SerializerCore : Serializer<ProcessedEmittableResourceDTO> {
        ...
        public SerializerCore(ProcessedEmittableResourceDTO obj, SerializationContext context) : base(obj, context) { }
