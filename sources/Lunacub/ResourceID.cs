    ...
    IUtf8SpanParsable<ResourceID>
{
    ...
    /// integer.
    /// </summary>
    /// <param name="other">The 64-bit unsigned integer to compare with the <see cref="Value"/> of the current instance.</param>
    /// <returns>
    ///     <see langword="true"/> if the <see cref="Value"/> of the current instance is equal to the provided 64-bit
